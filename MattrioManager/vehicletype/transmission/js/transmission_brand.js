...
function fn(){
	...
	$.ajax({
		url:network+"/MattrioManager/TransmissionCarManagerController/queryCarList",
		type:"post",
		data:{
			"pageindex":pageindex,
...
$(document).on("click",".delthis",function(){
	...
	if(confirm("是否删除")){
		$.ajax({
			type:"post",
			url:network+"/MattrioManager/TransmissionCarManagerController/deleteCarInfo",
			data:{
				"postion":postion
			},
			dataType:"json",
...
function datadel(){
	...
	if(confirm("是否删除")){
		$.ajax({
			type:"post",
			url:network+"/MattrioManager/TransmissionCarManagerController/deleteCarInfos",
			data:{
...
$(document).on("click",".endior",function(){
	...
	sessionStorage.setItem("pages",$(".current").html());
	window.location.href =  "transmission-revise.html?postion="+$(this).parents("td").parents("tr").children().eq(1).html();
});
...
$.ajax({
	type:"post",
	url:network+"/MattrioManager/TransmissionCarManagerController/getManufacture",
	dataType:"json",
	cache: false,
	crossDomain: true == !(document.all),
	success:function(data){
...
$("#s3").click(function(){
	...
	$.ajax({
		type:"post",
		url:network+"/MattrioManager/TransmissionCarManagerController/getVehicleName",
		data:{
...
$("#s4").click(function(){
	...
	$.ajax({
		type:"post",
		url:network+"/MattrioManager/TransmissionCarManagerController/getEngineCode",
		data:{
			"Manufacture":$("#arrcity").val(),
...
$("#s1").click(function(){
	...
	$.ajax({
		type:"post",
		url:network+"/MattrioManager/TransmissionCarManagerController/getCapacity",
		data:{
			"EngineCode":$("#s4").html(),
			"Manufacture":$("#arrcity").val(),
			"Vehicle_Name":$("#s3").html()
