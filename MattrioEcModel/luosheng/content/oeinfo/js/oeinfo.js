...
$("<img src='"+network+"/MattrioEcModel/upload/img/luosheng/"+particulars[id].img+"' onerror=\"javascript:this.src='../../image/blank.jpg'\">").appendTo($(".contentimg"));
$(".contentdiv").html(particulars[id].category_name);
$(".proct").html("");

var span11 = $("<span class='proctspan'>").html("产品类型：");
var span12 = $("<span>").html(particulars[id].category_name);
var p1 = $("<p>");
span11.appendTo(p1);
span12.appendTo(p1);
p1.appendTo(".proct");
...
$.ajax({
    ...
    success:function(data){
    	...
    	$.each(data.list,function(key,value){
            ...
            var $span4 = $("<span>").html(value.Capacity+value.Air_intake_form);
            $span1.appendTo(p);
            $span2.appendTo(p);
            $span3.appendTo(p);
            $span4.appendTo(p);
