...
var particulars = JSON.parse(localStorage.result);
...
$("<img src='http://mattrioec-img.oss-cn-shanghai.aliyuncs.com/"+username_id+"/"+particulars[id].product_id+".jpg' onerror=\"javascript:this.src='../../image/blank.jpg'\">").appendTo($(".contentimg"));
$(".contentdiv").html(particulars[id].category_name);
$(".proct").html("");
var span21 = $("<span class='proctspan'>").html("产品类型");
var span22 = $("<span>").html("："+particulars[id].category_name);
var p2 = $("<p>");
span21.appendTo(p2);
span22.appendTo(p2);
p2.appendTo(".proct");
...
var span22 = $("<span>").html("："+particulars[id].product_id);
var p2 = $("<p>");
span21.appendTo(p2);
span22.appendTo(p2);
p2.appendTo(".proct");
...
$.ajax({
    ...
    data:{
        ...
        "product_id":particulars[id].product_id,
        'mikey':particulars[id].mikey,
    },
    async:false,
    dataType:"json",
    success:function(data){
        ...
        $("<p>").html("<span class='proctspan'>底盘号</span>：<span>"+data.car_info[0].ChassisNumber+"</span>").appendTo(".proct");
    	...
    	$.each(data.list,function(key,value){
            ...
            var $span3 = $("<span>").html(value.Year_of_production);
            var Capacity=value.Capacity
            if(value.Capacity=='3'){
            	Capacity='3.0'
            }
            var $span4 = $("<span>").html(Capacity+' '+value.Air_intake_form);
            $span1.appendTo(p);
            $span2.appendTo(p);
            $span3.appendTo(p);
            $span4.appendTo(p);
...
//var span32 = $("<span>").html(particulars[id].oenumber);
//var p3 = $("<p>");
//span31.appendTo(p3);
//span32.appendTo(p3);
//p3.appendTo(".proct");
...
$(".error").click(function(){
    $(".errorcontent").show();
    $(".td1").html(particulars[id].product_id)
})
