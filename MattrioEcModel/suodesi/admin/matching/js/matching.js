...
/*获取发动机*/
$(document).on('click','.cartabwrap .cartype p',function(){
	var matching=sessionStorage.getItem('match')
	$(this).addClass('this')
	$(this).siblings().removeClass('this')	
...
/*获取年份*/
$(document).on('click','.underpan p',function(){
	$(this).addClass('this')
	$(this).siblings().removeClass('this')	
...
/*获取销售名称*/
$('.cartabwrap').on('click','.year p',function(){
	var matching=sessionStorage.getItem('match')
	$(this).addClass('this')
	$(this).siblings().removeClass('this')	
	$('.cartabwrap .carname').html('')
...
//	var Engine_Code=$('.engine').find('.this').text()
	...
	$("#loading").show()
	if($('.underpan').find('.this').length==0){
...
var matcharr=[]
var matchoearr=[]
$(document).on('click','.cartabwrap .add',function(e){
	stopPropagation(e)
...
/*车型查询删除*/
$(document).on('click','.cartabwrap .rem',function(){
	var title=$(this).parents('.cartab').find('.tit').text()
...
$('.matching').click(function(){
	$('#tbody').html('')
	$(".cartype,.underpan,.year,.carname").html('')
...
/*OE主机厂点击*/
$(document).on('click','.oetabwrap .car p',function(){
	var matchingoe=sessionStorage.getItem('matchoe')
	$(this).addClass('this')
	$(this).siblings().removeClass('this')	
...
/*OE车型点击*/
$(document).on('click','.oetabwrap .cartype p',function(){
	var matchingoe=sessionStorage.getItem('matchoe')
	$(this).addClass('this')
	$(this).siblings().removeClass('this')	
	$('.oetabwrap .year').html('')
...
/*OE年份点击*/
$(document).on('click','.oetabwrap .year p',function(){
	var matchingoe=sessionStorage.getItem('matchoe')
	$(this).addClass('this')
	$(this).siblings().removeClass('this')	
	$('.oetabwrap .carname').html('')
...
var oelist=[]
/*OE车型添加*/
$(document).on('click','.oetabwrap .add',function(e){
	stopPropagation(e)
	var title=$(this).parents('.cartab').find('.tit').text()
	$(this).parents('.cartab').nextAll('.cartab').find('a').remove()
	$(this).parents('p').addClass('this').siblings('p').removeClass('this')
...
/*oe车型删除*/
$(document).on('click','.oetabwrap .rem',function(){
	var title=$(this).parents('.cartab').find('.tit').text()
	var match=JSON.parse(sessionStorage.getItem('match'))
...
$(document).on('click','.listwrap p',function(e){
	stopPropagation(e)
	$('.oe').val($(this).text())
	$('.listwrap').addClass('active')	
})
