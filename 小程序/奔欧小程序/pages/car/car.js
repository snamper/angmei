...
Page({
  ...
  vagueclick(e){
    ...
    base.request('/MattrioEcModel/LikeQueryIntface/LikeQueryCars','POST',
    {
  ...
  mohuclick(e){
    ...
    base.request('/MattrioEcModel/SelectCarIntface/getProducts', 'POST',
      {
        "brand_id": username_id,
        "category_id": '"A"',
  ...
  wxaSortPickerItemTap(e){
    ...
    base.request('/MattrioEcModel/SelectCarIntface/getVehicleName','POST',
    {
      'brand_id': username_id,
  ...
  cartypeclick(e){
    ...
    // console.log(e)
    base.request('/MattrioEcModel/SelectCarIntface/getYear','POST',
    {
      'brand_id': username_id,
  ...
  yearclick(e){
    ...
    let that=this;
    base.request('/MattrioEcModel/SelectCarIntface/getCapacity','POST',
    {
      'brand_id': username_id,
  ...
  onShow: function () {
    ...
    base.request('/MattrioEcModel/SelectCarIntface/getManufacture','POST',
      {
        "brand_id": username_id
      },
      function (e) {
