...
//				displayItems(q);
			...
			function displayItems(items) {
				...
				if (items=='') {//热门城市遍历
					/*字母排序*/
					options.hot_list.sort(fn)
			        function fn(a,b){
			        	return a[3].substring(0,1).localeCompare(b[3].substring(0,1));
			        }
			        $.each(options.hot_list, function(key,value) {
		html+='<li rel="'+value[0]+'"><a href="#'+key+'"><span>'+value[2].substring(0,1)+'</span>'+value[1]+'</a></li>'
			        });
