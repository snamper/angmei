		...
		success:function(data){
			...
			$(".contentul li").click(function(){
				...
				$(".epc_a").click(function(){
					...
					$(this).attr("href","../content_tongyong_epc/content_tongyong_epc.html?carid="+car_id+"&id1="+category_id1+"&id2="+category_id2+"&name1="+name1+"&name2="+name2+"&img="+img+"&epcnum="+epcnum);
				});
			})
		}
	})
		...
		success:function(data){
			...
			$(".eachdiv").click(function(){
				...
				$(".epc_a").click(function(){
					...
					$(this).attr("href","../content_tongyong_epc/content_tongyong_epc.html?carid="+car_id+"&id1="+category_id1+"&id2="+category_id2+"&name2="+name2+"&img="+img+"&epcnum="+epcnum+"&no=-1");
				});
			})
			$(".epc_a").click(function(){
				if(sessionStorage) {
