...
var parameters=localStorage.getItem('HMCCParameters');
...
$("#next").click(function(){
	...
	getEpcInfo(userid,nplblk,hmodtyp);
    window.history.replaceState(null,null,'?e='+nplblk+'&f='+hmodtyp+'&oe='+oe+'&epcnum='+num+'&choice='+choice+'&h='+name1+'&i='+name2+'&imgsrc='+cont[num].img.split("?")[0]+'&parameters='+parameters+'&localtion='+localtion+'&type='+type)
})
...
//
			$("#viewer2").on('click','span',function(){
