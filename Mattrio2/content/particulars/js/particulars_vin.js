...
//				btn();
				...
				$(".wrap-nav1").html("<img src='https://mattrio-car-img.oss-cn-shanghai.aliyuncs.com/car_icon/"+res.list[0].car_icon+"'><span class='car-name' id='car-name'> "+res.list[0].Manufacture_CN+" "+res.list[0].Vehicle_Name_CN+" "+res.list[0].Capacity+" "+Transmission_description+"</span><p class='go_back'>返回上一页</p><button class='vin_error'>纠错</button>");
