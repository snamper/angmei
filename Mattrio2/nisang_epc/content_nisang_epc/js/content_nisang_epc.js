...
var image = img;
var parameters=localStorage.getItem('NissanParameters');
var carType='日产';
$(".name1").html(name1);
$(".name2").html(name2);
...
$("#next").click(function(){
	...
	getEpcInfo(userid,car_id,category_id2,category_id3,time,vin,true);
    window.history.replaceState(null,null,'?a='+car_id+'&b='+category_id2+'&c='+category_id3+'&d='+time+'&e='+cont[num].img.split("?")[0]+'&oe='+oe+'&epcnum='+num+'&choice='+choice+'&name1='+name1+'&name2='+name2+'&parameters='+parameters+'&vin='+vin)
    disable=true;
	$("#novin").text("已过滤");	
})
