	...
	$.ajax({
		...
		success:function(data){
			...
			$(".epc_a").click(function(){
				...
				$(this).attr("href","../content_benchi_epc/content_benchi_epc.html?a="+CATNUM+"&b="+data.categorys2[$(this).parents().index()].category_id1+"&c="+data.categorys2[$(this).parents().index()].category_id2+","+data.categorys2[$(this).parents().index()].img.split(".jpg")[0].split("benz_img/")[1]+"&d="+data.categorys2[$(this).parents().index()].img.split(".jpg")[0].split("benz_img/")[1]+"&oe="+$.trim($("#search").val())+"&epcnum="+$(this).parents(".contentname").index()+"&h="+$(".searchtwo").val()+"&i="+data.categorys2[$(this).parents().index()].category_name2+"&no=-1"+"&Vehicle_Name_CN="+Vehicle_Name_CN+"&vin="+vin);
			});
		}
	})
})
		...
		success:function(data){
			...
			$(".eachdiv").click(function(){
				...
				$(".epc_a").click(function(){
					...
					$(this).attr("href","../content_benchi_epc/content_benchi_epc.html?a="+CATNUM+"&b="+GROUPNUM+"&c="+SUBGRP+","+img+"&d="+img+"&oe="+$("#search").val()+"&epcnum="+$(this).parents(".contentname").index()+"&i="+name2+"&no=-1"+"&Vehicle_Name_CN="+Vehicle_Name_CN+"&vin="+vin);
				});
			})
			$(".epc_a").click(function(){
				if(sessionStorage) {
				...
				$(this).attr("href","../content_benchi_epc/content_benchi_epc.html?a="+CATNUM+"&b="+data.categorys2[$(this).parents().index()].category_id1+"&c="+data.categorys2[$(this).parents().index()].category_id2+","+data.categorys2[$(this).parents().index()].img.split(".jpg")[0].split("benz_img/")[1]+"&d="+data.categorys2[$(this).parents().index()].img.split(".jpg")[0].split("benz_img/")[1]+"&oe="+"&epcnum="+$(this).parents(".contentname").index()+"&h="+$(".searchtwo").val()+"&i="+data.categorys2[$(this).parents().index()].category_name2+"&no=-1"+"&Vehicle_Name_CN="+Vehicle_Name_CN+"&vin="+vin);
			});
		}
	})
})
