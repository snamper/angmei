...
function rightClick(data,name1,oe){
	$(".epc_a").click(function(){
		...
		$(this).attr("href","../content_fengtian_epc/content_fengtian_epc.html?a="+npl+"&b="+disc_no+"&c="+nserepcend+"&d="+nserepcstrt+"&e="+e+"&f="+hmodtyp+"&h="+name1+"&oe="+oe+"&epcnum="+$(this).parents(".contentname").index()+"&i="+i+"&parameters="+parameters+"&imgsrc="+imgsrc+'&vin='+vin);
	});
}
		...
		success:function(data){
			...
			$(".contentul li").click(function(){
				...
				$(".epc_a").click(function(){
					...
					$(this).attr("href","../content_fengtian_epc/content_fengtian_epc.html?a="+npl+"&b="+disc_no+"&c="+nserepcend+"&d="+nserepcstrt+"&e="+e+"&f="+hmodtyp+"&h="+name1+"&oe="+oe+"&epcnum="+epcnum+"&i="+i+"&parameters="+parameters+"&imgsrc="+imgsrc+'&vin='+vin);
				});
			})
		}
	})
