...
function rightClick(data,name1,oe,index){
	$(".epc_a").click(function(){
		if(index){
			var e = data.categorys2[index].category_id2;
			var i = data.categorys2[index].category_name2;
			var imgsrc=data.categorys2[index].img;
		}else{
		...
		$(this).attr("href","../content_haima_epc/content_haima_epc.html?a="+npl+"&b="+disc_no+"&c="+nserepcend+"&d="+nserepcstrt+"&e="+e+"&f="+hmodtyp+"&h="+name1+"&oe="+oe+"&epcnum="+$(this).parents(".contentname").index()+"&i="+i+"&parameters="+parameters+"&imgsrc="+imgsrc+"&type="+type);
	});
}
		...
		success:function(data){
			...
			$(".contentul li").click(function(){
				...
				$(".epc_a").click(function(){
					...
					if(type=="11"){
						$(this).attr("href","../content_haima_epc/content_haima_epc.html?a="+npl+"&b="+disc_no+"&c="+nserepcend+"&d="+nserepcstrt+"&e="+e+"&f="+hmodtyp+"&h="+name1+"&oe="+oe+"&epcnum="+epcnum+"&i="+i+"&parameters="+parameters+"&imgsrc="+imgsrc+"&type=11");
					}else{
						$(this).attr("href","../content_haima_epc/content_haima_epc.html?a="+npl+"&b="+disc_no+"&c="+nserepcend+"&d="+nserepcstrt+"&e="+e+"&f="+hmodtyp+"&h="+name1+"&oe="+oe+"&epcnum="+epcnum+"&i="+i+"&parameters="+parameters+"&imgsrc="+imgsrc);
					}
				});
			})
		}
