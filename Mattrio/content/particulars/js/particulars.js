...
if(key.length == 0 || key == []){
	...
	$(".last").on("click",".epcbtn",function(){
		...
		if(str.indexOf("宝马")>=0 || str.indexOf("MINI")>=0){
			...
			if(searc == ""){
				window.location.href="../../mazida_epc/mazida_epc/mazida_epc.html?mikey="+key.mikey;
			}else{
				window.location.href="../../mazida_epc/mazida_epc/mazida_epc.html?vin="+searc;
			}	
		}else if(str.indexOf("丰田")>=0){
			if(searc == ""){
				window.location.href="../../fengtian_epc/fengtian_epc/fengtian_epc.html?mikey="+key.mikey;
			}else{
				window.location.href="../../fengtian_epc/fengtian_epc/fengtian_epc.html?vin="+searc;
			}
		}else if(str.indexOf("海马")>=0){
				window.location.href="../../haima_epc/haima_epc/haima_epc.html?mikey="+key.mikey;
		}else if(str.indexOf("长城")>=0){
			window.location.href="../../haima_epc/haima_epc/haima_epc.html?mikey="+key.mikey+"&type=11";
		}
