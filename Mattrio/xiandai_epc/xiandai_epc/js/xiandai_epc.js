			...
			$.ajax({
				...
				success:function(data){
					...
					$(".epc_a").click(function(){
						...
						$(this).attr("href","../content_xiandai_epc/content_xiandai_epc.html?a="+MLBPNO+"&b="+data.categorys2[$(this).parents().index()].category_id2.split(",")[0]+"&c="+data.categorys2[$(this).parents().index()].category_id2.split(",")[1]+"&d="+MLUC01+"&e="+MLUC02+"&f="+MLUC03+"&g="+MLUC04+"&h="+MLUC05+"&i="+data.categorys2[$(this).parents().index()].img.split("?")[0]+"&oe="+$("#search").val()+"&epcnum="+$(this).parents().index()+"&name1="+name1+"&name2="+data.categorys2[$(this).parents().index()].category_name2+"&parameters="+parameters+"&vin="+vin);
					});
				}
			})
		}
	...
	$.ajax({
		...
		success:function(data){
			...
			$(".epc_a").click(function(){
				...
				$(this).attr("href","../content_xiandai_epc/content_xiandai_epc.html?a="+MLBPNO+"&b="+data.categorys2[$(this).parents().index()].category_id2.split(",")[0]+"&c="+data.categorys2[$(this).parents().index()].category_id2.split(",")[1]+"&d="+MLUC01+"&e="+MLUC02+"&f="+MLUC03+"&g="+MLUC04+"&h="+MLUC05+"&i="+data.categorys2[$(this).parents().index()].img.split("?")[0]+"&oe="+$("#search").val()+"&epcnum="+$(this).parents(".contentname").index()+"&name1="+name1+"&name2="+data.categorys2[$(this).parents().index()].category_name2+"&parameters="+parameters+"&vin="+vin);
			});
			$(".contentul li").click(function(){
				...
				$(".epc_a").click(function(){
					...
					$(this).attr("href","../content_xiandai_epc/content_xiandai_epc.html?a="+MLBPNO+"&b="+b+"&c="+c+"&d="+MLUC01+"&e="+MLUC02+"&f="+MLUC03+"&g="+MLUC04+"&h="+MLUC05+"&i="+img+"&oe="+"&epcnum="+epcnum+"&name1="+name1+"&name2="+name2+"&parameters="+parameters+"&vin="+vin);
				});
		...
		success:function(data){
			...
			$(".eachdiv").click(function(){
				...
				$(".epc_a").click(function(){
					...
					$(this).attr("href","../content_xiandai_epc/content_xiandai_epc.html?a="+MLBPNO+"&b="+gmugno+"&c="+GIILPG+"&d="+MLUC01+"&e="+MLUC02+"&f="+MLUC03+"&g="+MLUC04+"&h="+MLUC05+"&i="+img+"&oe="+$("#search").val()+"&epcnum="+epcnum+"&name2="+name2+"&parameters="+parameters+"&vin="+vin);
				});
			})
			$(".epc_a").click(function(){
				if(sessionStorage) {
				...
				$(this).attr("href","../content_xiandai_epc/content_xiandai_epc.html?a="+MLBPNO+"&b="+data.categorys2[$(this).parents().index()].category_id2.split(",")[0]+"&c="+data.categorys2[$(this).parents().index()].category_id2.split(",")[1]+"&d="+MLUC01+"&e="+MLUC02+"&f="+MLUC03+"&g="+MLUC04+"&h="+MLUC05+"&i="+data.categorys2[$(this).parents().index()].img.split("?")[0]+"&oe="+$("#search").val()+"&epcnum="+$(this).parents(".contentname").index()+"&name2="+data.categorys2[$(this).parents().index()].category_name2+"&parameters="+parameters+"&vin="+vin);
			});
		}
	})
})
	...
	$.ajax({
		...
		success:function(data){
			...
			$(".epc_a").click(function(){
				...
				$(this).attr("href","../content_xiandai_epc/content_xiandai_epc.html?a="+MLBPNO+"&b="+data.categorys2[$(this).parents().index()].category_id2.split(",")[0]+"&c="+data.categorys2[$(this).parents().index()].category_id2.split(",")[1]+"&d="+MLUC01+"&e="+MLUC02+"&f="+MLUC03+"&g="+MLUC04+"&h="+MLUC05+"&i="+data.categorys2[$(this).parents().index()].img.split("?")[0]+"&oe="+$.trim($("#search").val())+"&epcnum="+$(this).parents(".contentname").index()+"&name1="+"&name2="+data.categorys2[$(this).parents().index()].category_name2+"&parameters="+parameters+"&vin="+vin);
			});
		}
	})
})
