			...
			$.ajax({
				...
				success:function(data){
					...
					$(".epc_a").click(function(){
						...
						$(this).attr("href","../content_nisang_epc/content_nisang_epc.html?a="+car_id+"&b="+data.categorys2[$(this).parents().index()].category_id2.split(",")[0]+"&c="+data.categorys2[$(this).parents().index()].category_id2.split(",")[1]+"&d="+time+"&e="+data.categorys2[$(this).parents().index()].img.split("?")[0]+"&oe="+$("#search").val()+"&name1="+name1+"&name2="+data.categorys2[$(this).parents().index()].category_name2+"&epcnum="+$(this).parents(".contentname").index()+"&parameters="+parameters+'&vin='+vin);
					});
				}
			})
		}
		...
		success:function(data){
			...
			$(".contentul li").click(function(){
				...
				$(".epc_a").click(function(){
					...
					$(this).attr("href","../content_nisang_epc/content_nisang_epc.html?a="+car_id+"&b="+b+"&c="+c+"&d="+time+"&e="+img+"&oe="+$("#search").val()+"&name1="+name1+"&name2="+name2+"&epcnum="+$(this).parents(".contentname").index()+"&parameters="+parameters+'&vin='+vin);
				});
		...
		success:function(data){
			...
			$(".eachdiv").click(function(){
				...
				$(".epc_a").click(function(){
					...
					$(this).attr("href","../content_nisang_epc/content_nisang_epc.html?a="+car_id+"&b="+b+"&c="+c+"&d="+time+"&e="+img+"&oe="+$("#search").val()+"&name1=&name2="+name2+"&epcnum="+$(this).parents(".contentname").index()+'&vin='+vin);
				});
			})
			$(".epc_a").click(function(){
				...
				$(this).attr("href","../content_nisang_epc/content_nisang_epc.html?a="+car_id+"&b="+data.categorys2[$(this).parents().index()].category_id2.split(",")[0]+"&c="+data.categorys2[$(this).parents().index()].category_id2.split(",")[1]+"&d="+time+"&e="+img+"&oe="+$("#search").val()+"&name1=&name2="+data.categorys2[$(this).parents().index()].category_name2+"&epcnum="+$(this).parents(".contentname").index()+"&parameters="+parameters+'&vin='+vin);
			});
		}
	})
})
	...
	$.ajax({
		...
		success:function(data){
			...
			$(".epc_a").click(function(){
				...
				$(this).attr("href","../content_nisang_epc/content_nisang_epc.html?a="+car_id+"&b="+data.categorys2[$(this).parents().index()].category_id2.split(",")[0]+"&c="+data.categorys2[$(this).parents().index()].category_id2.split(",")[1]+"&d="+time+"&e="+img+"&oe="+$.trim($("#search").val())+"&name1=&name2="+data.categorys2[$(this).parents().index()].category_name2+"&epcnum="+$(this).parents(".contentname").index()+"&parameters="+parameters+'&vin='+vin);
			});
		}
	})
})
